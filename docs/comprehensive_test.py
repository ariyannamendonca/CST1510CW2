...
from app.data.incidents import insert_incident, update_incident_status, get_incidents_by_type_count, \
    get_high_severity_by_status, delete_incident_status
...
def run_comprehensive_tests():
    ...
    # Delete
    delete_incident_status(conn, test_id)
